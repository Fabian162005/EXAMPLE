...
<head>
    ...
    <title> partido pais para todos</title>
...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <img src="{{ asset('imagenes/image25.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<main>
    ...
    <section class="py-20 bg-yellow-400 text-black">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Por un Perú inclusivo, justo y libre de corrupción.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll text-yellow-600">Historia del Partido</h2>
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">
                Origen y evolución del Partido País Para Todos
            </p>

            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-gray-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    <div class="text-black mb-4 text-4xl">
                        <i class="fas fa-flag"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Fundación</h3>
                    <p class="text-gray-700">
                        Fundado en 2023 por el exalcalde de Huaraz, Vladimir Meza, con el objetivo de renovar la política peruana y combatir la corrupción.
                    </p>
                </div>
                ...
                <div class="bg-gray-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">
                        El 2 de agosto de 2024, el partido logró su inscripción en el Registro de Organizaciones Políticas del JNE.
                    </p>
                </div>
                ...
                <div class="bg-gray-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">
                        Gana notoriedad nacional con la participación del humorista Carlos Álvarez como precandidato presidencial.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-yellow-50">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll text-yellow-600">Liderazgo Actual</h2>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Vladimir Meza</h3>
                    <p class="text-gray-700 mb-2 font-medium">Presidente y Fundador</p>
                    <p class="text-gray-700">Economista y exalcalde de Huaraz. Lidera el partido con visión de renovación política.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Carlos Álvarez</h3>
                    <p class="text-gray-700 mb-2 font-medium">Precandidato Presidencial</p>
                    <p class="text-gray-700">Humorista y activista social que busca luchar contra la corrupción desde la política.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll text-yellow-600">Nuestros Principios</h2>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-yellow-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-black">Anticorrupción</h3>
                    <p class="text-gray-700 text-sm">Erradicar la corrupción en todos los niveles del Estado.</p>
                </div>
                <div class="bg-yellow-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-black">Inclusión Social</h3>
                    <p class="text-gray-700 text-sm">Integrar a todos los sectores de la sociedad peruana.</p>
                </div>
                <div class="bg-yellow-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-black">Justicia y Transparencia</h3>
                    <p class="text-gray-700 text-sm">Sistema judicial justo y transparente.</p>
                </div>
                <div class="bg-yellow-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-black">Desarrollo Sostenible</h3>
                    <p class="text-gray-700 text-sm">Crecimiento económico respetando el medio ambiente.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-100">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll text-yellow-600">Propuestas Clave</h2>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">Transformar el sistema judicial, garantizando independencia y eficiencia.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-black mb-4 text-4xl">
                    ...
                    <p class="text-gray-700">Desarrollo sostenible y protección del medio ambiente.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Cierre -->
    <section class="py-16 bg-yellow-400 text-black text-center">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold mb-4 animate-on-scroll">¡Únete al Partido País Para Todos!</h2>
            <p class="text-xl max-w-2xl mx-auto mb-8 animate-on-scroll">
                Trabajamos por un Perú más justo, inclusivo y transparente. Sé parte del cambio.
            </p>
            <a href="https://www.facebook.com/partidopaisparatodos" class="bg-black text-white font-semibold px-6 py-3 rounded-full hover:bg-gray-800 transition">
                Conoce más
            </a>
        </div>
    </section>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image25.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

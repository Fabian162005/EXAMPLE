...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div class="logo-container animate__animated animate__fadeIn">
            <img src="{{ asset('imagenes/image13.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<!-- Contenido principal -->
<main>
    <!-- Hero Section - Gradiente azul a rojo -->
    <section class="py-20 bg-gradient-to-r from-blue-600 to-red-600 text-white">
        <div class="container mx-auto px-4 text-center">
            <h1 class="text-4xl md:text-6xl font-bold mb-6 animate__animated animate__fadeInDown">Batalla Perú</h1>
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Partido político peruano nacionalista fundado en 2022. Promueve la soberanía nacional, justicia social y lucha contra la corrupción.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll">Historia de Batalla Perú</h2>
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Trayectoria de un movimiento político emergente</p>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Fundación en 2022</h3>
                    <p class="text-gray-600">Fundado el 15 de agosto de 2022 por el exmilitar y congresista Antauro Humala. Surge como movimiento nacionalista que reivindica el levantamiento de Andahuaylas (2005).</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Nacionalismo Etnocacerista</h3>
                    <p class="text-gray-600">Inspirado en las ideas de Isaac Humala (padre del fundador), promueve un nacionalismo radical con reivindicaciones indígenas y antiimperialistas.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale" style="animation-delay: 0.4s;">
                    ...
                    <p class="text-gray-600">En proceso de consolidación. Busca participar en elecciones regionales y nacionales con candidaturas que representen sus principios nacionalistas.</p> 
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Antauro Humala Tasso</h3>
                    <p class="text-gray-600 mb-2 font-medium">Líder y Fundador</p>
                    <p class="text-gray-600">Exmilitar y excongresista. Líder del levantamiento de Andahuaylas (2005). Cumplió condena hasta 2021. Actualmente lidera el movimiento político.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <p class="text-gray-600">Incluye a exmilitares y líderes locales que comparten la ideología etnocacerista. Figuras como Marco Vizcarra y Abel Cuzque apoyan al movimiento.</p>
                </div>
            </div>

            <!-- Nota histórica -->
            <div class="mt-12 text-center text-gray-500">
                <p>Ideólogo histórico: <span class="font-medium">Isaac Humala</span> (creador de la doctrina etnocacerista)</p>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Bases doctrinarias del movimiento</p>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-blue-600">Nacionalismo Radical</h3>
                    <p class="text-gray-600 text-sm mb-4">Defensa extrema de soberanía nacional, recursos naturales y rechazo a influencias extranjeras.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.1s;">
                    <h3 class="text-xl font-semibold mb-1 text-red-600">Etnocacerismo</h3>
                    <p class="text-gray-600 text-sm mb-4">Reivindicación de raíces indígenas y figura de Andrés Avelino Cáceres como modelo.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    <h3 class="text-xl font-semibold mb-1 text-blue-600">Rol del Militarismo</h3>
                    <p class="text-gray-600 text-sm mb-4">Fortalecimiento de las FFAA y propuesta de gobierno civil-militar para "salvar la patria".</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.3s;">
                    <h3 class="text-xl font-semibold mb-1 text-red-600">Economía Nacionalista</h3>
                    <p class="text-gray-600 text-sm mb-4">Control estatal de recursos estratégicos y limitación a inversión extranjera en sectores clave.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.4s;">
                    <h3 class="text-xl font-semibold mb-1 text-blue-600">Justicia Social</h3>
                    <p class="text-gray-600 text-sm mb-4">Redistribución de riqueza y combate a oligarquías mediante reformas radicales.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.5s;">
                    <h3 class="text-xl font-semibold mb-1 text-red-600">Anticorrupción</h3>
                    <p class="text-gray-600 text-sm mb-4">Propuesta de mano dura contra la corrupción con castigos ejemplares.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-600">Recuperación control estatal sobre recursos naturales, revisión de contratos con multinacionales y fortalecimiento fronterizo.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Reformas Radicales</h3>
                    <p class="text-gray-600">Propuesta de Asamblea Constituyente para nuevo modelo de Estado con mayor participación militar y popular.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Principales hitos del movimiento</p>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <div class="p-6">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                            <i class="far fa-calendar-alt mr-2"></i> Enero 2005
                        </div>
                        <h3 class="text-xl font-semibold mb-3">Levantamiento de Andahuaylas</h3>
                        <p class="text-gray-600 mb-4">Acción armada dirigida por Antauro Humala que derivó en la muerte de 4 policías. Base ideológica del actual movimiento.</p>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    <div class="h-48 bg-red-100 flex items-center justify-center">
                        <i class="fas fa-bullhorn text-5xl text-red-600"></i>
                    </div>
                    <div class="p-6">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                            <i class="far fa-calendar-alt mr-2"></i> 2022-actualidad
                        </div>
                        <h3 class="text-xl font-semibold mb-3">Activismo Político</h3>
                        <p class="text-gray-600 mb-4">Movilizaciones y discurso político nacionalista con apoyo en sectores del sur andino y grupos radicalizados.</p>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.4s;">
                    ...
                    <div class="p-6">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                            <i class="far fa-calendar-alt mr-2"></i> 2024
                        </div>
                        <h3 class="text-xl font-semibold mb-3">Propuestas Contundentes</h3>
                        <p class="text-gray-600 mb-4">Planteamientos radicales para reformar el Estado, sistema político y modelo económico desde perspectiva nacionalista.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image13.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

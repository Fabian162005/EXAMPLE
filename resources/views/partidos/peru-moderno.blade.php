...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <img src="{{ asset('imagenes/image24.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<!-- Contenido principal -->
<main>
    <!-- Hero Section - Colores fucsia y amarillo -->
    <section class="py-20 bg-gradient-to-r from-fuchsia-600 to-yellow-400 text-white">
        <div class="container mx-auto px-4 text-center">
            <h1 class="text-4xl md:text-6xl font-bold mb-6 animate__animated animate__fadeInDown">Perú Moderno</h1>
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Partido político peruano de centro-derecha fundado en 2023. Promueve modernización del Estado, economía competitiva y justicia social.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll">Historia de Perú Moderno</h2>
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Construyendo una nueva alternativa política</p>
            
            <div class="grid md:grid-cols-3 gap-8">
                <!-- Fundación -->
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    <div class="text-fuchsia-600 mb-4 text-4xl floating">
                        <i class="fas fa-rocket"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Fundación en 2023</h3>
                    <p class="text-gray-600">Creado el 12 de marzo de 2023 por un grupo de empresarios, tecnócratas y exfuncionarios públicos liderados por Julio Velarde Flores.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Modernidad Progresista</h3>
                    <p class="text-gray-600">Combina economía de mercado con políticas sociales efectivas, uso de tecnología y gestión por resultados.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale" style="animation-delay: 0.4s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Proyección Electoral</h3>
                    <p class="text-gray-600">Preparando su primera participación en elecciones generales 2026 con candidatos técnicos y planes de gobierno basados en evidencia.</p> 
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">El equipo que impulsa el cambio</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Julio Velarde Flores</h3>
                    <p class="text-gray-600 mb-2 font-medium">Presidente y Fundador</p>
                    <p class="text-gray-600">Exministro de Economía y actual presidente del BCR. Economista con amplia experiencia en gestión pública y sector privado.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Equipo Técnico</h3>
                    <p class="text-gray-600 mb-2 font-medium">Liderazgo colectivo</p>
                    <p class="text-gray-600">Incluye a exministros como Carlos Oliva, economistas jóvenes y expertos en gestión pública con visión moderna.</p>
                </div>
            </div>

            <!-- Nota -->
            <div class="mt-12 text-center text-gray-500">
                <p>Lema: <span class="font-medium">"Modernidad con resultados para todos"</span> | <span class="font-medium">Colores oficiales:</span> <span class="text-fuchsia-600">Fucsia</span> + <span class="text-yellow-400">Amarillo</span></p>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-fuchsia-600 mb-2 text-xl">
                        <i class="fas fa-briefcase"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-1">Economía Competitiva</h3>
                    <p class="text-gray-600 text-sm mb-4">Atracción de inversiones, simplificación tributaria y apoyo a emprendimientos con potencial de crecimiento.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.1s;">
                    ...
                    <h3 class="text-xl font-semibold mb-1">Estado Eficiente</h3>
                    <p class="text-gray-600 text-sm mb-4">Modernización de la administración pública con gobierno digital y evaluación por resultados.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-1">Inclusión Productiva</h3>
                    <p class="text-gray-600 text-sm mb-4">Programas sociales con enfoque de generación de empleo y capacitación técnica.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.3s;">
                    ...
                    <h3 class="text-xl font-semibold mb-1">Educación 4.0</h3>
                    <p class="text-gray-600 text-sm mb-4">Reforma educativa con enfoque en habilidades digitales, inglés y pensamiento crítico.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.4s;">
                    ...
                    <h3 class="text-xl font-semibold mb-1">Crecimiento Verde</h3>
                    <p class="text-gray-600 text-sm mb-4">Desarrollo económico sostenible con energías renovables y manejo responsable de recursos.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.5s;">
                    ...
                    <h3 class="text-xl font-semibold mb-1">Transformación Digital</h3>
                    <p class="text-gray-600 text-sm mb-4">Implementación de tecnologías emergentes en sectores productivos y servicios públicos.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll">Propuestas Centrales</h2>
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Soluciones innovadoras para el Perú</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Reactivación Inteligente</h3>
                    <p class="text-gray-600">Plan de estímulos sectoriales con apoyo a MYPES tecnológicas y reconversión laboral para la economía digital.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Seguridad 2.0</h3>
                    <p class="text-gray-600">Sistema integrado de videovigilancia con IA, reforma policial y prevención basada en data analytics.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll">Proyectos Emblemáticos</h2>
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Iniciativas que marcan la diferencia</p>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="h-48 bg-fuchsia-50 flex items-center justify-center"> <!-- Fondo fucsia claro -->
                        <i class="fas fa-laptop-code text-5xl text-fuchsia-600"></i> <!-- Icono fucsia -->
                    </div>
                    <div class="p-6">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                            <i class="far fa-calendar-alt mr-2"></i> Propuesta 2024
                        </div>
                        <h3 class="text-xl font-semibold mb-3">Gobierno Digital</h3>
                        <p class="text-gray-600 mb-4">Plataforma unificada de trámites estatales con firma digital y pagos electrónicos para eliminar burocracia.</p>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    <div class="h-48 bg-fuchsia-50 flex items-center justify-center"> <!-- Fondo fucsia claro -->
                        <i class="fas fa-road text-5xl text-fuchsia-600"></i> <!-- Icono fucsia -->
                    </div>
                    <div class="p-6">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                            <i class="far fa-calendar-alt mr-2"></i> Propuesta 2024
                        </div>
                        <h3 class="text-xl font-semibold mb-3">Infraestructura 4.0</h3>
                        <p class="text-gray-600 mb-4">Corredores logísticos inteligentes con IoT y sistemas de transporte multimodal sostenible.</p>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.4s;">
                    <div class="h-48 bg-fuchsia-50 flex items-center justify-center"> <!-- Fondo fucsia claro -->
                        <i class="fas fa-robot text-5xl text-fuchsia-600"></i> <!-- Icono fucsia -->
                    </div>
                    <div class="p-6">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                            <i class="far fa-calendar-alt mr-2"></i> Propuesta 2024
                        </div>
                        <h3 class="text-xl font-semibold mb-3">Escuelas del Futuro</h3>
                        <p class="text-gray-600 mb-4">Aulas equipadas con realidad aumentada, programación desde primaria y docentes capacitados en tecnologías educativas.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image24.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

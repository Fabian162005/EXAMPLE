...
<head>
    ...
    <title>Partido Ciudanos por el Perú </title>
...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div class="logo-container animate__animated animate__fadeIn">
            <img src="{{ asset('imagenes/image17.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<main>
    ...
    <section class="py-20 bg-gradient-to-r from-blue-900 to-blue-800 text-white">
        <div class="container mx-auto px-4 text-center">
            <h1 class="text-4xl md:text-6xl font-bold mb-6 animate__animated animate__fadeInDown">Partido Ciudadanos por el Perú</h1>
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Partido recientemente inscrito en el JNE, con una visión de transformación democrática, inclusión social y fortalecimiento del Estado para el desarrollo nacional.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Orígenes recientes y perspectivas</p>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Inscripción en 2025</h3>
                    <p class="text-gray-600">El partido fue inscrito oficialmente en enero de 2025 ante el Jurado Nacional de Elecciones, como un nuevo actor político con proyección nacional.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Ideología Ciudadana</h3>
                    <p class="text-gray-600">Promueve un enfoque de democracia participativa, fortalecimiento de instituciones, transparencia, desarrollo territorial y derechos sociales.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale" style="animation-delay: 0.4s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Camino Electoral</h3>
                    <p class="text-gray-600">Aún sin presencia en cargos nacionales, se prepara para participar en las elecciones generales de 2026 con una agenda de reformas institucionales.</p> 
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Nicanor Boluarte</h3>
                    <p class="text-gray-600 mb-2 font-medium">Fundador vinculado</p>
                    <p class="text-gray-600">Figura clave en la inscripción del partido. Su participación ha generado controversia por vínculos familiares y judiciales.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Julio César Tenorio</h3>
                    <p class="text-gray-600 mb-2 font-medium">Secretario General</p>
                    <p class="text-gray-600">Actual representante legal del partido, encargado de la coordinación nacional y su proyección hacia las elecciones de 2026.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Compromiso con el país y la equidad</p>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Promueve una mayor autonomía regional para cerrar brechas territoriales.</p>
                </div>
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1">Participación Ciudadana</h3>
                    <p class="text-gray-600 text-sm mb-4">Fortalecimiento del rol activo de la población en la toma de decisiones públicas.</p>
                </div>
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1">Transparencia</h3>
                    <p class="text-gray-600 text-sm mb-4">Impulso a mecanismos de rendición de cuentas y lucha contra la corrupción.</p>
                </div>
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1">Desarrollo Humano</h3>
                    <p class="text-gray-600 text-sm mb-4">Políticas sociales para mejorar salud, educación y oportunidades económicas.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Agenda ciudadana con visión de futuro</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Educación Transformadora</h3>
                    <p class="text-gray-600">Inversión en calidad educativa, tecnología, y formación docente con equidad regional.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-blue-800 mb-4 text-4xl floating">
                        <i class="fas fa-briefcase"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Empleo Digno</h3>
                    <p class="text-gray-600">Programas para fomentar empleo formal, productivo e inclusivo a nivel nacional.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-blue-800 mb-4 text-4xl floating">
                        <i class="fas fa-notes-medical"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Salud Universal</h3>
                    <p class="text-gray-600">Cobertura y acceso garantizado a servicios de salud preventiva y especializada.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-blue-800 mb-4 text-4xl floating">
                    ...
                    <p class="text-gray-600">Modernización institucional, mejora del servicio público y acceso digital.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Cierre -->
    <section class="py-16 bg-gradient-to-r from-blue-900 to-blue-800 text-white text-center">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold mb-4 animate-on-scroll">Compromiso con el Perú</h2>
            <p class="text-xl max-w-2xl mx-auto mb-8 animate-on-scroll">
                Ciudadanos por el Perú se proyecta como una nueva alternativa con propuestas modernas y una firme convicción de justicia social y participación ciudadana.
            </p>
            <a href="https://www.facebook.com/CiudadanosPP" target="_blank" class="bg-white text-blue-900 font-semibold px-6 py-3 rounded-full hover:bg-gray-200 transition">Visita su página oficial</a>
        </div>
    </section>
</main>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image17.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

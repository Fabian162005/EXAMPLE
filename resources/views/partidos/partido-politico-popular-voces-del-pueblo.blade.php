...
<head>
    ...
    <title>partido politico popular voces del pueblo</title>
...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <img src="{{ asset('imagenes/image32.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<main>
    ...
    <section class="py-20 bg-gradient-to-r from-red-600 to-red-800 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Luchamos por la voz de cada peruano, equidad social y progreso colectivo
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">
                Una historia forjada desde las bases del pueblo
            </p>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-red-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">
                        Surgimos en 2019 como colectivo popular en defensa de los derechos ciudadanos.
                    </p>
                </div>
                ...
                <div class="bg-red-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">
                        Nos constituimos como partido político oficial en 2022 con respaldo ciudadano amplio.
                    </p>
                </div>
                ...
                <div class="bg-red-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">
                        Contamos con miles de afiliados y representación en más de 20 regiones del Perú.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-red-50">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Nuestros líderes representativos</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Héctor Ramírez</h3>
                    <p class="text-gray-700 mb-2 font-medium">Presidente Nacional</p>
                    <p class="text-gray-700">Líder comunitario con trayectoria en defensa de derechos laborales y políticas inclusivas.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Luz Marina Carrillo</h3>
                    <p class="text-gray-700 mb-2 font-medium">Secretaria General</p>
                    <p class="text-gray-700">Docente y activista social, defensora del acceso igualitario a la educación y salud.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Lo que nos define</p>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-800">Participación Popular</h3>
                    <p class="text-gray-700 text-sm">El pueblo como protagonista en las decisiones de Estado.</p>
                </div>
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-800">Justicia Social</h3>
                    <p class="text-gray-700 text-sm">Reducción de desigualdades y atención prioritaria a los más vulnerables.</p>
                </div>
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-800">Soberanía Nacional</h3>
                    <p class="text-gray-700 text-sm">Defensa de los recursos naturales y decisiones autónomas.</p>
                </div>
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-800">Solidaridad</h3>
                    <p class="text-gray-700 text-sm">Unión entre peruanos para avanzar juntos como nación.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-red-50">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Soluciones reales para el Perú</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Reforma Social Integral</h3>
                    <p class="text-gray-700">Acceso garantizado a salud, educación y vivienda digna para todos.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-white bg-red-700 w-12 h-12 flex items-center justify-center rounded-full mb-4 text-2xl">
                    ...
                    <p class="text-gray-700">Impulso a la economía local, cooperativas y emprendimientos sostenibles.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gradient-to-r from-red-700 to-red-900 text-white text-center">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold mb-4 animate-on-scroll">¡Súmate a Voces del Pueblo!</h2>
            <p class="text-xl max-w-2xl mx-auto mb-8 animate-on-scroll">
                Tu voz cuenta. Únete al cambio que el Perú necesita desde las raíces del pueblo.
            </p>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image32.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

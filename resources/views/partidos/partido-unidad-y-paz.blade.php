...
<head>
    ...
    <title>partido unidad y paz</title>
...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <img src="{{ asset('imagenes/image42.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<main>
    ...
    <section class="py-20 bg-gradient-to-r from-red-700 to-red-900 text-white">
        <div class="container mx-auto px-4 text-center">
            <div class="flex justify-center mb-6">
                <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-lg border-4 border-red-500">
                    <span class="text-red-700 text-2xl font-bold">UyP</span>
                </div>
            </div>
            <h1 class="text-4xl md:text-6xl font-bold mb-6 animate__animated animate__fadeInDown">
                Partido Unidad y La Paz
            </h1>
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Pasión por un Perú unido y en armonía
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">
                Una trayectoria de lucha por la concordia nacional
            </p>

            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-red-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale border-t-4 border-red-600">
                    ...
                    <p class="text-gray-700">
                        Nacimos en 2018 para unir a peruanos de todas las tendencias políticas.
                    </p>
                </div>

                <div class="bg-red-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale border-t-4 border-red-700">
                    <div class="text-white bg-red-700 w-12 h-12 flex items-center justify-center rounded-full mb-4 text-2xl">
                        <i class="fas fa-dove"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Reconocimiento</h3>
                    <p class="text-gray-700">
                        Inscritos oficialmente en 2020 con apoyo multisectorial.
                    </p>
                </div>

                <div class="bg-red-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale border-t-4 border-red-800">
                    ...
                    <p class="text-gray-700">
                        Más de 60,000 afiliados y presencia en 20 regiones del país.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-red-50">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll text-red-800">Nuestros Líderes</h2>
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Guías comprometidos con la unidad nacional</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale border-l-4 border-red-600">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Carlos Ramírez</h3>
                    <p class="text-gray-700 mb-2 font-medium">Presidente Nacional</p>
                    <p class="text-gray-700">Ex mediador de la ONU con experiencia en resolución de conflictos internacionales.</p>
                </div>

                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale border-l-4 border-red-700">
                    <div class="text-white bg-red-700 w-12 h-12 flex items-center justify-center rounded-full mb-4 text-2xl">
                        <i class="fas fa-female"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Luisa Fernández</h3>
                    <p class="text-gray-700 mb-2 font-medium">Secretaria General</p>
                    <p class="text-gray-700">Líder social premiada por su trabajo en zonas de posconflicto.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll text-red-700">Nuestros Compromisos</h2>
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Los pilares de nuestra acción política</p>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-900">Unidad Nacional</h3>
                    <p class="text-gray-700 text-sm">Trabajamos por superar divisiones y construir consensos.</p>
                </div>
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-900">Diálogo Social</h3>
                    <p class="text-gray-700 text-sm">Promovemos el entendimiento entre todos los peruanos.</p>
                </div>
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-900">Paz con Justicia</h3>
                    <p class="text-gray-700 text-sm">Buscamos reconciliación sin impunidad.</p>
                </div>
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-900">Desarrollo Integral</h3>
                    <p class="text-gray-700 text-sm">Progreso económico con equidad social.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-red-50">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll text-red-800">Nuestras Propuestas</h2>
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Agenda para la unidad nacional</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Pacto por el Perú</h3>
                    <p class="text-gray-700">Acuerdo nacional con metas comunes a 20 años.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-white bg-red-700 w-12 h-12 flex items-center justify-center rounded-full mb-4 text-2xl">
                        <i class="fas fa-school"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Educación para la Paz</h3>
                    <p class="text-gray-700">Reforma educativa que fomente cultura de diálogo.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image42.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

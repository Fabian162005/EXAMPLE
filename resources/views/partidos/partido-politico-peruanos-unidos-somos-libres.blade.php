...
<head>
    ...
    <title>partido politico peruanos unidos somos libres</title>
...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <img src="{{ asset('imagenes/image29.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<main>
    ...
    <section class="py-20 bg-gradient-to-r from-red-600 to-red-800 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Un partido democrático con vocación integradora, justicia y desarrollo para todos los peruanos
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">
                Comprometidos con la democracia y el bienestar del país
            </p>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-red-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Orígenes</h3>
                    <p class="text-gray-700">
                        Fundado en 2021 como plataforma ciudadana, se constituyó como partido en 2023.
                    </p>
                </div>
                ...
                <div class="bg-red-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">
                        Inscrito oficialmente en el Registro de Organizaciones Políticas (ROP) en 2024.
                    </p>
                </div>
                ...
                <div class="bg-red-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">
                        Con miles de afiliados y bases organizadas en todas las regiones del Perú.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-red-50">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll text-red-700">Liderazgo</h2>
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Voceros del cambio</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">César Guzmán Balcázar</h3>
                    <p class="text-gray-700 mb-2 font-medium">Presidente del Partido</p>
                    <p class="text-gray-700">Líder con amplia experiencia en organización social y defensa de los derechos ciudadanos.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Patricia Quispe</h3>
                    <p class="text-gray-700 mb-2 font-medium">Secretaria Nacional de Organización</p>
                    <p class="text-gray-700">Activista y abogada comprometida con la participación política inclusiva.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Lo que defendemos</p>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-800">Democracia Participativa</h3>
                    <p class="text-gray-700 text-sm">Fomentamos una ciudadanía activa y consciente.</p>
                </div>
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-800">Justicia Social</h3>
                    <p class="text-gray-700 text-sm">Combatimos la desigualdad desde el territorio.</p>
                </div>
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-800">Soberanía Nacional</h3>
                    <p class="text-gray-700 text-sm">Defensa de los intereses del Perú frente a intereses externos.</p>
                </div>
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-800">Inclusión</h3>
                    <p class="text-gray-700 text-sm">Todos los peruanos cuentan, sin discriminación.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-red-50">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Ideas para transformar el país</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Educación Pública Gratuita y Digna</h3>
                    <p class="text-gray-700">Incremento del presupuesto y mejora de infraestructura y formación docente.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-white bg-red-700 w-12 h-12 flex items-center justify-center rounded-full mb-4 text-2xl">
                        <i class="fas fa-seedling"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Soberanía Alimentaria</h3>
                    <p class="text-gray-700">Apoyo directo al pequeño agricultor y a la producción local de alimentos.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Cierre -->
    <section class="py-16 bg-gradient-to-r from-red-700 to-red-900 text-white text-center">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold mb-4 animate-on-scroll">¡Únete a Peruanos Unidos!</h2>
            <p class="text-xl max-w-2xl mx-auto mb-8 animate-on-scroll">
                Sé parte de la nueva generación de cambio político. El Perú merece más y tú puedes ayudar a lograrlo.
            </p>
            <a href="#contacto" class="bg-white text-red-700 font-semibold px-6 py-3 rounded-full hover:bg-gray-100 transition">
                Quiero participar
            </a>
        </div>
    </section>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image29.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

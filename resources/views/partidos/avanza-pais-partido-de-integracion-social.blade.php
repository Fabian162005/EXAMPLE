...
<head>
    ...
    <title>Avanza pais partido de integracion</title>
...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div class="logo-container animate__animated animate__fadeIn">
            <img src="{{ asset('imagenes/image10.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<main>
    ...
    <section class="py-20 bg-gradient-to-r from-red-600 to-red-800 text-white">
        <div class="container mx-auto px-4 text-center">
            <h1 class="text-4xl md:text-6xl font-bold mb-6 animate__animated animate__fadeInDown">Avanza País</h1>
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Partido político peruano de derecha fundado en 2020. Promueve la integración social, el desarrollo económico y la seguridad ciudadana.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll">Historia de Avanza País</h2>
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Trayectoria de un partido emergente</p>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-600">Fundado oficialmente el 12 de noviembre de 2020 por Hernando de Soto y otros economistas e intelectuales. Surge como alternativa política técnica y pragmática.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Elecciones 2021</h3>
                    <p class="text-gray-600">Participó por primera vez en elecciones generales obteniendo 7 escaños en el Congreso, posicionándose como una nueva fuerza política.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale" style="animation-delay: 0.4s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Consolidación</h3>
                    <p class="text-gray-600">En 2024 mantiene presencia en el Congreso y gobiernos locales, enfocándose en propuestas técnicas de desarrollo económico y social.</p> 
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Aldo Borrero García</h3>
                    <p class="text-gray-600 mb-2 font-medium">Presidente Nacional</p>
                    <p class="text-gray-600">Abogado y político, congresista de la República desde 2021. Lidera la bancada parlamentaria del partido.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Figuras Clave</h3>
                    <p class="text-gray-600 mb-2 font-medium">Liderazgo compartido</p>
                    <p class="text-gray-600">Incluye a congresistas como Alejandro Cavero (ideólogo) y Karol Paredes, así como al economista Hernando de Soto como referente intelectual.</p>
                </div>
            </div>

            <!-- Nota histórica -->
            <div class="mt-12 text-center text-gray-500">
                <p>Referente intelectual: <span class="font-medium">Hernando de Soto</span> (fundador y principal ideólogo)</p>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1">Economía de Mercado</h3>
                    <p class="text-gray-600 text-sm mb-4">Promoción de políticas económicas liberales con énfasis en propiedad formal y emprendimiento.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.1s;">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Políticas de mano dura contra la delincuencia combinadas con prevención social.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    <h3 class="text-xl font-semibold mb-1">Integración Social</h3>
                    <p class="text-gray-600 text-sm mb-4">Inclusión económica de los informales mediante políticas de formalización.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.3s;">
                    <h3 class="text-xl font-semibold mb-1">Reformas Institucionales</h3>
                    <p class="text-gray-600 text-sm mb-4">Modernización del Estado para hacerlo más eficiente y cercano al ciudadano.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.4s;">
                    <h3 class="text-xl font-semibold mb-1">Educación Técnica</h3>
                    <p class="text-gray-600 text-sm mb-4">Fomento de educación técnica y capacitación laboral para mejorar empleabilidad.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.5s;">
                    <h3 class="text-xl font-semibold mb-1">Salud Preventiva</h3>
                    <p class="text-gray-600 text-sm mb-4">Mejoramiento del sistema de salud con enfoque en prevención y atención primaria.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-600">Propuestas para dinamizar la economía mediante simplificación administrativa, reducción de trámites y apoyo a MYPES.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Combate a la Inseguridad</h3>
                    <p class="text-gray-600">Plan integral contra la delincuencia que incluye reforma policial, endurecimiento de penas y programas de prevención.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="h-48 bg-red-100 flex items-center justify-center">
                        <i class="fas fa-file-alt text-5xl text-red-500"></i>
                    </div>
                    <div class="p-6">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                            <i class="far fa-calendar-alt mr-2"></i> 2021-2024
                        </div>
                        <h3 class="text-xl font-semibold mb-3">Iniciativas Legislativas</h3>
                        <p class="text-gray-600 mb-4">Presentación de proyectos para simplificación administrativa, reforma del sistema penitenciario y promoción de inversiones.</p>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    <div class="h-48 bg-red-100 flex items-center justify-center">
                        <i class="fas fa-comments text-5xl text-red-500"></i>
                    </div>
                    <div class="p-6">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                            <i class="far fa-calendar-alt mr-2"></i> 2021-2024
                        ...
                        <p class="text-gray-600 mb-4">Posicionamiento de temas como formalización, seguridad ciudadana y reforma del Estado en el debate nacional.</p>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.4s;">
                    <div class="h-48 bg-red-100 flex items-center justify-center">
                        <i class="fas fa-brain text-5xl text-red-500"></i>
                    </div>
                    <div class="p-6">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                            <i class="far fa-calendar-alt mr-2"></i> 2020-actualidad
                        </div>
                        <h3 class="text-xl font-semibold mb-3">Enfoque Técnico</h3>
                        <p class="text-gray-600 mb-4">Aportes intelectuales y técnicos a políticas públicas desde el Instituto Libertad y Democracia de Hernando de Soto.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image10.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

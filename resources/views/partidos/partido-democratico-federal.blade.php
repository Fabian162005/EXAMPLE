...
<head>
    ...
    <title>Partido democratico deferal</title>
...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <img src="{{ asset('imagenes/image15.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<main>
    <!-- Hero Section -->
    <section class="py-20 bg-gradient-to-r from-red-800 to-red-600 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Por un Perú descentralizado, soberano y moderno. Federalismo con identidad y justicia social.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">
                Federalismo con raíces ancestrales
            </p>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-600">
                        Inscrito oficialmente el 21 de enero de 2025, liderado por Virgilio Acuña Peralta, excongresista (2011–2016).
                    </p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Inspiración</h3>
                    <p class="text-gray-600">
                        Basado en el modelo ancestral del Tawantinsuyo, busca una organización federal que respete las identidades regionales.
                    </p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Visión Global</h3>
                    <p class="text-gray-600">
                        Aspira a convertir al Perú en un país de primer mundo, tomando como referencia modelos de desarrollo exitosos.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Voceros del federalismo peruano</p>
            ...
            <div class="grid md:grid-cols-1 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Virgilio Acuña Peralta</h3>
                    <p class="text-gray-600 mb-2 font-medium">Presidente del Partido Democrático Federal</p>
                    <p class="text-gray-600 mb-1"><strong>Experiencia:</strong> Excongresista (2011–2016)</p>
                    <p class="text-gray-600"><strong>Apoderado legal:</strong> Walter Gamonal Bravo</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Valores que nos guían</p>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1">Federalismo Integrador</h3>
                    <p class="text-gray-600 text-sm mb-4">Descentralización efectiva que reconoce la diversidad cultural y regional del Perú.</p>
                </div>
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1">Identidad Nacional</h3>
                    <p class="text-gray-600 text-sm mb-4">Reivindicación de nuestras raíces ancestrales y fortalecimiento de la identidad peruana.</p>
                </div>
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1">Justicia Social</h3>
                    <p class="text-gray-600 text-sm mb-4">Compromiso con la equidad, la inclusión y el respeto a los derechos humanos.</p>
                </div>
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1">Soberanía Nacional</h3>
                    <p class="text-gray-600 text-sm mb-4">Defensa de la independencia tecnológica, alimentaria y territorial del país.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Agenda para un Perú Federal</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Desarrollo Industrial</h3>
                    <p class="text-gray-600">Implementación de la cuarta revolución industrial en todas las regiones del país.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-red-700 mb-4 text-4xl floating">
                        <i class="fas fa-graduation-cap"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Educación de Calidad</h3>
                    <p class="text-gray-600">Acceso universal a una educación integral que promueva el desarrollo humano y tecnológico.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-red-700 mb-4 text-4xl floating">
                        <i class="fas fa-seedling"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Sostenibilidad Ambiental</h3>
                    <p class="text-gray-600">Protección del medio ambiente y promoción de prácticas sostenibles en todas las regiones.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-red-700 mb-4 text-4xl floating">
                    ...
                    <p class="text-gray-600">Autonomía del poder judicial y lucha frontal contra la corrupción en todos los niveles.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Cierre -->
    <section class="py-16 bg-gradient-to-r from-red-800 to-red-600 text-white text-center">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold mb-4 animate-on-scroll">¡Construyamos juntos un Perú Federal!</h2>
            <p class="text-xl max-w-2xl mx-auto mb-8 animate-on-scroll">
                El Partido Democrático Federal trabaja por un país descentralizado, justo y soberano. Únete al cambio.
            </p>
            <a href="https://democraticofederal.com/" class="bg-white text-red-800 font-semibold px-6 py-3 rounded-full hover:bg-gray-200 transition">
                Conoce más
            </a>
        </div>
    </section>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image15.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

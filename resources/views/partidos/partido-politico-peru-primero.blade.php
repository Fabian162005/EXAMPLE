...
<head>
    ...
    <title>partido politico peru primero</title>
...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <img src="{{ asset('imagenes/image26.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
    ...
    <section class="py-20 bg-red-700 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                ¡Por un Perú justo, democrático y con oportunidades para todos!
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">
                Origen y evolución de Perú Primero
            </p>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-gray-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">
                        Fundado el 8 de noviembre de 2021 por el expresidente Martín Vizcarra, con el objetivo de promover una política centrada en el ciudadano. ([peruprimero.pe](https://peruprimero.pe/nosotros/?utm_source=chatgpt.com))
                    </p>
                </div>

                <div class="bg-gray-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    <div class="text-white bg-white w-12 h-12 flex items-center justify-center rounded-full mb-4 text-2xl border border-red-700">
                        <i class="fas fa-check-circle text-red-700"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Inscripción Oficial</h3>
                    <p class="text-gray-700">
                        Inscrito oficialmente ante el Jurado Nacional de Elecciones en mayo de 2023, con el símbolo de un número 1 rojo en un cuadrado blanco con bordes rojos. ([rpp.pe](https://rpp.pe/politica/elecciones/martin-vizcarra-anuncio-inscripcion-de-su-partido-politico-peru-primero-ante-el-jne-noticia-1482250?utm_source=chatgpt.com))
                    </p>
                </div>
                ...
                <div class="bg-gray-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">
                        Desde su inscripción, el partido ha trabajado en fortalecer su presencia a nivel nacional, enfocándose en la descentralización y participación ciudadana. ([peruprimero.pe](https://peruprimero.pe/nosotros/?utm_source=chatgpt.com))
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Martín Vizcarra</h3>
                    <p class="text-gray-700 mb-2 font-medium">Fundador</p>
                    <p class="text-gray-700">Expresidente del Perú (2018-2020), promotor de una política centrada en el ciudadano y la transparencia. ([peruprimero.pe](https://peruprimero.pe/nosotros/?utm_source=chatgpt.com))</p>
                </div>

                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-white bg-white w-12 h-12 flex items-center justify-center rounded-full mb-4 text-2xl border border-red-700">
                        <i class="fas fa-user-tie text-red-700"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Carlos Illanes Calderón</h3>
                    <p class="text-gray-700 mb-2 font-medium">Personero Legal</p>
                    <p class="text-gray-700">Encargado de la representación legal del partido ante el Jurado Nacional de Elecciones. ([rpp.pe](https://rpp.pe/politica/elecciones/martin-vizcarra-anuncio-inscripcion-de-su-partido-politico-peru-primero-ante-el-jne-noticia-1482250?utm_source=chatgpt.com))</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-black">Ética</h3>
                    <p class="text-gray-700 text-sm">Promovemos normas y actos que valoren el comportamiento humano, respetando los Derechos Humanos y protegiendo la vida desde la familia como célula fundamental de la sociedad. ([peruprimero.pe](https://peruprimero.pe/nosotros/?utm_source=chatgpt.com))</p>
                </div>
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-black">Democracia</h3>
                    <p class="text-gray-700 text-sm">Defendemos la soberanía del pueblo y su derecho a elegir, ser elegido, controlar y fiscalizar a sus gobernantes, respetando el estado de derecho y el equilibrio de poderes. ([peruprimero.pe](https://peruprimero.pe/nosotros/?utm_source=chatgpt.com))</p>
                </div>
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-black">Libertad</h3>
                    <p class="text-gray-700 text-sm">Respetamos la condición del ser humano para actuar según sus valores, criterios, razón y voluntad. ([peruprimero.pe](https://peruprimero.pe/nosotros/?utm_source=chatgpt.com))</p>
                </div>
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-black">Transparencia</h3>
                    <p class="text-gray-700 text-sm">Gestionamos nuestras cuentas y financiamiento de manera transparente, con publicidad oportuna de estas. ([peruprimero.pe](https://peruprimero.pe/nosotros/?utm_source=chatgpt.com))</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image26.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

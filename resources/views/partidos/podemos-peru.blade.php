...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <img src="{{ asset('imagenes/image27.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<!-- Contenido principal -->
<main>
    <!-- Hero Section - Colores azul oscuro y amarillo oscuro -->
    <section class="py-20 bg-gradient-to-r from-blue-800 to-yellow-600 text-white">
        <div class="container mx-auto px-4 text-center">
            <h1 class="text-4xl md:text-6xl font-bold mb-6 animate__animated animate__fadeInDown">Podemos Perú</h1>
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Partido político peruano de izquierda fundado en 2017. Promueve justicia social, igualdad de oportunidades y defensa de los derechos del pueblo.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll">Historia de Podemos Perú</h2>
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Luchando por un Perú más justo e igualitario</p>
            
            <div class="grid md:grid-cols-3 gap-8">
                <!-- Fundación -->
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    <div class="text-blue-800 mb-4 text-4xl floating">
                        <i class="fas fa-fist-raised"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Fundación en 2017</h3>
                    <p class="text-gray-600">Creado el 15 de septiembre de 2017 por un movimiento de bases sociales, sindicalistas y líderes populares comprometidos con el cambio social.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Socialismo Democrático</h3>
                    <p class="text-gray-600">Promueve la redistribución de la riqueza, derechos laborales, acceso universal a salud y educación de calidad.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale" style="animation-delay: 0.4s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Trayectoria Electoral</h3>
                    <p class="text-gray-600">Participó en las elecciones generales 2021 obteniendo importante representación congresal y presencia en gobiernos regionales.</p> 
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Los representantes del pueblo</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">José Luna Gálvez</h3>
                    <p class="text-gray-600 mb-2 font-medium">Secretario General</p>
                    <p class="text-gray-600">Líder sindical con amplia trayectoria en la defensa de los derechos laborales y ex congresista de la República.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Consejo Directivo</h3>
                    <p class="text-gray-600 mb-2 font-medium">Liderazgo colectivo</p>
                    <p class="text-gray-600">Integrado por dirigentes sindicales, representantes de organizaciones sociales y líderes regionales comprometidos con el cambio.</p>
                </div>
            </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-blue-800 mb-2 text-xl">
                        <i class="fas fa-hand-holding-usd"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-1">Economía Popular</h3>
                    <p class="text-gray-600 text-sm mb-4">Promoción de la economía solidaria, apoyo a pequeños productores y regulación de monopolios.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.1s;">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Redistribución equitativa de la riqueza y acceso universal a servicios básicos de calidad.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-1">Salud Pública</h3>
                    <p class="text-gray-600 text-sm mb-4">Sistema nacional de salud gratuito, universal y de calidad para todos los peruanos.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.3s;">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Educación gratuita, científica y popular en todos los niveles, con énfasis en la educación técnica.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.4s;">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Defensa de los recursos naturales y promoción de su explotación racional en beneficio del pueblo.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.5s;">
                    ...
                    <h3 class="text-xl font-semibold mb-1">Derechos Laborales</h3>
                    <p class="text-gray-600 text-sm mb-4">Trabajo digno, salarios justos, sindicalización libre y protección social para todos los trabajadores.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Soluciones para el pueblo trabajador</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Seguridad Alimentaria</h3>
                    <p class="text-gray-600">Programa nacional de alimentación popular con comedores comunitarios y apoyo a la agricultura familiar.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Vivienda Digna</h3>
                    <p class="text-gray-600">Plan masivo de construcción de viviendas sociales con servicios básicos para familias de bajos recursos.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Iniciativas para el bienestar popular</p>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="h-48 bg-blue-50 flex items-center justify-center">
                        <i class="fas fa-pills text-5xl text-blue-800"></i>
                    </div>
                    <div class="p-6">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                            <i class="far fa-calendar-alt mr-2"></i> Propuesta 2024
                        </div>
                        <h3 class="text-xl font-semibold mb-3">Salud para Todos</h3>
                        <p class="text-gray-600 mb-4">Red nacional de postas médicas y hospitales con medicamentos gratuitos y atención especializada accesible.</p>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    <div class="h-48 bg-blue-50 flex items-center justify-center">
                        <i class="fas fa-graduation-cap text-5xl text-blue-800"></i>
                    </div>
                    <div class="p-6">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                            <i class="far fa-calendar-alt mr-2"></i> Propuesta 2024
                        </div>
                        <h3 class="text-xl font-semibold mb-3">Universidad Popular</h3>
                        <p class="text-gray-600 mb-4">Educación superior gratuita con becas integrales para estudiantes de bajos recursos en todas las regiones.</p>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.4s;">
                    <div class="h-48 bg-blue-50 flex items-center justify-center">
                        <i class="fas fa-tractor text-5xl text-blue-800"></i>
                    </div>
                    <div class="p-6">
                        <div class="flex items-center text-sm text-gray-500 mb-2">
                            <i class="far fa-calendar-alt mr-2"></i> Propuesta 2024
                        </div>
                        <h3 class="text-xl font-semibold mb-3">Reforma Agraria</h3>
                        <p class="text-gray-600 mb-4">Apoyo técnico y financiero a pequeños agricultores, con precios justos y mercados garantizados.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image27.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

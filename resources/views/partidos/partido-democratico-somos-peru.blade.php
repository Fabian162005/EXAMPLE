...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <img src="{{ asset('imagenes/image18.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<main>
    ...
    <section class="py-20 bg-gradient-to-r from-red-800 to-red-600 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Comprometidos con la democracia, la descentralización y el desarrollo del Perú.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">
                Trayectoria y evolución de Somos Perú
            </p>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-600">
                        Fundado por el exalcalde de Lima, Alberto Andrade, con el objetivo de promover una política democrática y descentralizada en el Perú.
                    </p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-600">
                        En las elecciones regionales y municipales de 2022, Somos Perú obtuvo 7 gobiernos regionales y 28 alcaldías provinciales, consolidando su presencia a nivel nacional.
                    </p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-600">
                        En 2024, el alcalde de Surco, Carlos Bruce, se unió a Somos Perú, fortaleciendo la agrupación de cara a las elecciones de 2026.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Dirigentes y figuras clave</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Patricia Li</h3>
                    <p class="text-gray-600 mb-2 font-medium">Presidenta del Partido</p>
                    <p class="text-gray-600">Lidera la organización desde 2021, enfocándose en fortalecer la democracia interna y la participación ciudadana.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Carlos Bruce</h3>
                    <p class="text-gray-600 mb-2 font-medium">Alcalde de Surco</p>
                    <p class="text-gray-600">Se unió a Somos Perú en septiembre de 2024, aportando su experiencia política y liderazgo local.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Valores fundamentales</p>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Fomentamos la participación activa de la ciudadanía en la toma de decisiones políticas.</p>
                </div>
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1">Descentralización</h3>
                    <p class="text-gray-600 text-sm mb-4">Promovemos el fortalecimiento de las regiones y gobiernos locales para un desarrollo equitativo.</p>
                </div>
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1">Transparencia</h3>
                    <p class="text-gray-600 text-sm mb-4">Comprometidos con la rendición de cuentas y la lucha contra la corrupción en todos los niveles de gobierno.</p>
                </div>
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1">Justicia Social</h3>
                    <p class="text-gray-600 text-sm mb-4">Trabajamos por una sociedad más equitativa, con oportunidades para todos los peruanos.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Agenda legislativa y política</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Reelección de Autoridades</h3>
                    <p class="text-gray-600">Propuesta de reforma constitucional para permitir la reelección inmediata por un periodo adicional de alcaldes y gobernadores regionales.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-red-700 mb-4 text-4xl floating">
                    ...
                    <p class="text-gray-600">Proyecto de ley para eliminar las fotografías de los candidatos en las cédulas de sufragio, promoviendo el enfoque en propuestas y partidos.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gradient-to-r from-red-800 to-red-600 text-white text-center">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold mb-4 animate-on-scroll">¡Únete a Somos Perú!</h2>
            <p class="text-xl max-w-2xl mx-auto mb-8 animate-on-scroll">
                Trabajamos por un Perú más justo, descentralizado y democrático. Sé parte del cambio.
            </p>
            <a href="https://somosperu.org.pe/" class="bg-white text-red-800 font-semibold px-6 py-3 rounded-full hover:bg-gray-200 transition">
                Conoce más
            </a>
        </div>
    </section>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image18.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

...
<head>
    ...
    <title>partido politico prin</title>
...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <img src="{{ asset('imagenes/image33.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<main>
        ...
        <div class="container mx-auto px-4 text-center">
            <div class="flex justify-center mb-6">
                <div class="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-lg">
                    <span class="text-red-600 text-2xl font-bold">PRIN</span>
                </div>
            </div>
            ...
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Renovación política e integración nacional para el Perú del siglo XXI
            </p>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-red-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Renovación</h3>
                    <p class="text-gray-700">
                        Fundado en 2020 por jóvenes profesionales y líderes regionales buscando cambiar el sistema político.
                    </p>
                </div>
                ...
                <div class="bg-red-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Integración</h3>
                    <p class="text-gray-700">
                        Primer partido con estructura genuinamente descentralizada y representación paritaria.
                    </p>
                </div>
                ...
                <div class="bg-red-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">
                        Inscrito oficialmente en 2022 con el aval de más de 180,000 firmas en todo el país.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Carlos Mendoza</h3>
                    <p class="text-gray-700 mb-2 font-medium">Coordinador Nacional</p>
                    <p class="text-gray-700">Ex rector de universidad nacional y experto en políticas educativas con visión descentralista.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700 mb-2 font-medium">Secretaria de Programas</p>
                    <p class="text-gray-700">Ingeniera y tecnóloga premiada internacionalmente, impulsora de innovación pública.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Los principios que nos guían</p>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-900">Renovación Ética</h3>
                    <p class="text-gray-700 text-sm">Cero tolerancia a la corrupción y meritocracia en la función pública.</p>
                </div>
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-900">Integración Nacional</h3>
                    <p class="text-gray-700 text-sm">Desarrollo equilibrado de todas las regiones del país.</p>
                </div>
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-900">Innovación Pública</h3>
                    <p class="text-gray-700 text-sm">Modernización del Estado con tecnología y gestión eficiente.</p>
                </div>
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-900">Sostenibilidad</h3>
                    <p class="text-gray-700 text-sm">Crecimiento económico compatible con protección ambiental.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-red-50">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll text-red-700">Agenda PRIN</h2>
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Nuestras principales propuestas</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">Transformación digital completa del Estado para eliminar trámites y combatir la corrupción.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-white bg-red-700 w-12 h-12 flex items-center justify-center rounded-full mb-4 text-2xl">
                        <i class="fas fa-map-marked-alt"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Descentralización Real</h3>
                    <p class="text-gray-700">Transferencia efectiva de competencias y recursos a gobiernos regionales y locales.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image33.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

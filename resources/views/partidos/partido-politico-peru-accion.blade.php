...
<head>
    ...
    <title>partido politico peru accion</title>
...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <img src="{{ asset('imagenes/image23.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<main>
    ...
    <section class="py-20 bg-gradient-to-r from-red-600 to-red-800 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Movimiento por la unidad nacional, desarrollo sostenible y justicia social
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">
                Una trayectoria de servicio al país
            </p>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-red-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">
                        Nacimos en 2018 como movimiento ciudadano, convirtiéndonos en partido político en 2020.
                    </p>
                </div>
                ...
                <div class="bg-red-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">
                        Inscritos oficialmente en el JNE en 2021 con apoyo masivo de la sociedad civil.
                    </p>
                </div>
                ...
                <div class="bg-red-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">
                        Más de 100,000 militantes activos y presencia en las 25 regiones del país.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-red-50">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Nuestros representantes</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Ricardo Mendoza</h3>
                    <p class="text-gray-700 mb-2 font-medium">Presidente Nacional</p>
                    <p class="text-gray-700">Exalcalde de Lima y reconocido líder social con 20 años de experiencia en gestión pública transparente.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">María Elena Torres</h3>
                    <p class="text-gray-700 mb-2 font-medium">Secretaria General</p>
                    <p class="text-gray-700">Economista especializada en desarrollo social, exviceministra de Economía.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Pilares fundamentales</p>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-800">Unidad Nacional</h3>
                    <p class="text-gray-700 text-sm">Trabajamos por un Perú unido, sin divisiones regionales ni sociales.</p>
                </div>
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-800">Desarrollo Sostenible</h3>
                    <p class="text-gray-700 text-sm">Crecimiento económico con protección ambiental y justicia social.</p>
                </div>
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-800">Transparencia</h3>
                    <p class="text-gray-700 text-sm">Gestión pública honesta y rendición de cuentas permanente.</p>
                </div>
                <div class="bg-red-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-red-800">Acción Ciudadana</h3>
                    <p class="text-gray-700 text-sm">Participación activa de la sociedad en las decisiones políticas.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-red-50">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Agenda para el cambio</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Pacto Social</h3>
                    <p class="text-gray-700">Reforma del Estado para garantizar educación y salud de calidad para todos los peruanos.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-white bg-red-700 w-12 h-12 flex items-center justify-center rounded-full mb-4 text-2xl">
                        <i class="fas fa-chart-line"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Economía Productiva</h3>
                    <p class="text-gray-700">Impulso a la industria nacional, agricultura y empleo digno con derechos laborales.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gradient-to-r from-red-700 to-red-900 text-white text-center">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold mb-4 animate-on-scroll">¡Únete a Perú Acción!</h2>
            <p class="text-xl max-w-2xl mx-auto mb-8 animate-on-scroll">
                Juntos podemos construir un Perú más justo, unido y desarrollado. Tu participación es vital.
            </p>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image23.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

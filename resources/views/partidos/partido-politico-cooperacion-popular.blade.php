...
<head>
    ...
    <title>partido politico cooperacion popular</title>
...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <img src="{{ asset('imagenes/image31.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<main>
    <!-- Sección Hero -->
    <section class="py-20 bg-pink-600 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Forjando una comunidad basada en la justicia, la honradez y el desarrollo.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll text-pink-600">Historia del Partido</h2>
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">
                Origen y evolución del Partido Cooperación Popular
            </p>

            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-gray-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    <div class="text-white bg-pink-600 w-12 h-12 flex items-center justify-center rounded-full mb-4 text-2xl">
                        <i class="fas fa-seedling"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Fundación</h3>
                    <p class="text-gray-700">
                        Fundado con el propósito de generar espacios para que la ciudadanía pueda proponer, participar y fiscalizar las acciones del Estado.
                    </p>
                </div>

                <div class="bg-gray-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    <div class="text-white bg-blue-600 w-12 h-12 flex items-center justify-center rounded-full mb-4 text-2xl">
                        <i class="fas fa-check-circle"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Inscripción Oficial</h3>
                    <p class="text-gray-700">
                        Inscrito en el Registro de Organizaciones Políticas del JNE, habilitado para participar en las Elecciones Generales 2026.
                    </p>
                </div>
                ...
                <div class="bg-gray-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">
                        Incorporación de figuras destacadas como el excandidato presidencial Yonhy Lescano y el congresista Carlos Zeballos.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-blue-50">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll text-pink-600">Liderazgo Actual</h2>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Gabriela Rosa Maxi Velazque</h3>
                    <p class="text-gray-700 mb-2 font-medium">Presidenta</p>
                    <p class="text-gray-700">Lidera el partido con una visión centrada en la justicia, la honradez y el desarrollo.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Carlos Javier Zeballos Madariaga</h3>
                    <p class="text-gray-700 mb-2 font-medium">Secretario Nacional General Político</p>
                    <p class="text-gray-700">Congresista de la República, aporta su experiencia política al fortalecimiento del partido.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll text-pink-600">Nuestros Principios</h2>
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Valores fundamentales</p>

            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-pink-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-black">Justicia</h3>
                    <p class="text-gray-700 text-sm">Promovemos una sociedad donde prevalezca la equidad y el respeto a los derechos humanos.</p>
                </div>
                <div class="bg-pink-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-black">Honradez</h3>
                    <p class="text-gray-700 text-sm">Rechazamos firmemente la corrupción y fomentamos la transparencia en la gestión pública.</p>
                </div>
                <div class="bg-pink-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-black">Desarrollo</h3>
                    <p class="text-gray-700 text-sm">Impulsamos políticas que promuevan el crecimiento sostenible y el bienestar de todos los peruanos.</p>
                </div>
                <div class="bg-pink-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-black">Participación Ciudadana</h3>
                    <p class="text-gray-700 text-sm">Fomentamos la participación activa de la ciudadanía en la toma de decisiones políticas.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-100">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll text-pink-600">Propuestas Clave</h2>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">Transformar el sistema judicial para garantizar independencia y eficiencia en la administración de justicia.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-white bg-blue-600 w-12 h-12 flex items-center justify-center rounded-full mb-4 text-2xl">
                        <i class="fas fa-leaf"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Política Ambiental</h3>
                    <p class="text-gray-700">Implementar políticas de conservación y uso responsable de recursos para una economía sostenible.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-pink-600 text-white text-center">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold mb-4 animate-on-scroll">¡Únete a Cooperación Popular!</h2>
            <p class="text-xl max-w-2xl mx-auto mb-8 animate-on-scroll">
                Trabajamos por un Perú más justo, honesto y desarrollado. Sé parte del cambio.
            </p>
            <a href="https://cooperacionpopular.com/" class="bg-white text-pink-600 font-semibold px-6 py-3 rounded-full hover:bg-gray-200 transition">
                Conoce más
            </a>
        </div>
    </section>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image31.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

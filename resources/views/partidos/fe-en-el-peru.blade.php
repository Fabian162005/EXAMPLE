...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div class="logo-container animate__animated animate__fadeIn">
            <img src="{{ asset('imagenes/image16.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<main>
    ...
    <section class="py-20 bg-gradient-to-r from-green-600 to-green-800 text-white">
        <div class="container mx-auto px-4 text-center">
            <h1 class="text-4xl md:text-6xl font-bold mb-6 animate__animated animate__fadeInDown">Fe en el Perú</h1>
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Partido político peruano fundado en 2021 que promueve la fe, familia, trabajo y vida, con una visión humanista y de justicia social.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll">Historia de Fe en el Perú</h2>
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Nacimiento de un partido con raíces en la fe y los valores familiares</p>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-600">Fe en el Perú fue inscrito como partido político en 2021 por Álvaro Paz de la Barra, exalcalde de La Molina y abogado constitucionalista.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Humanismo Cristiano</h3>
                    <p class="text-gray-600">Se basa en los valores del humanismo cristiano, promoviendo la dignidad de la persona, la justicia social y la defensa de la vida desde la concepción.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale" style="animation-delay: 0.4s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Participación Política</h3>
                    <p class="text-gray-600">Participó en las elecciones municipales y regionales, enfocándose en propuestas de gobernabilidad, valores, familia y lucha contra la corrupción.</p> 
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Dirigencia del partido Fe en el Perú</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Álvaro Paz de la Barra</h3>
                    <p class="text-gray-600 mb-2 font-medium">Presidente y Fundador</p>
                    <p class="text-gray-600">Con formación en derecho, lidera el partido con una visión centrada en valores familiares, institucionalidad y justicia social.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Organización Interna</h3>
                    <p class="text-gray-600 mb-2 font-medium">Estructura Nacional</p>
                    <p class="text-gray-600">Cuenta con dirigencias regionales, comités juveniles y redes de voluntarios comprometidos con una política basada en valores.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Ejes que definen su propuesta política</p>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-green-600">Defensa de la Vida</h3>
                    <p class="text-gray-600 text-sm mb-4">Comprometido con la vida desde la concepción hasta la muerte natural.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.1s;">
                    <h3 class="text-xl font-semibold mb-1 text-green-600">Fortalecimiento de la Familia</h3>
                    <p class="text-gray-600 text-sm mb-4">La familia es el núcleo fundamental de la sociedad peruana.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    <h3 class="text-xl font-semibold mb-1 text-green-600">Trabajo y Desarrollo</h3>
                    <p class="text-gray-600 text-sm mb-4">Impulso al emprendimiento, trabajo digno y políticas productivas inclusivas.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.3s;">
                    <h3 class="text-xl font-semibold mb-1 text-green-600">Justicia y Transparencia</h3>
                    <p class="text-gray-600 text-sm mb-4">Lucha contra la corrupción e implementación de justicia eficiente y transparente.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll">Situación Actual y Propuestas</h2>
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Compromisos actuales del partido</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Bienestar Integral</h3>
                    <p class="text-gray-600">Desarrollo humano con acceso a salud, educación y oportunidades para todos.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <p class="text-gray-600">Propuesta de un Estado eficiente, con meritocracia, sin privilegios y enfocado en el servicio ciudadano.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image16.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

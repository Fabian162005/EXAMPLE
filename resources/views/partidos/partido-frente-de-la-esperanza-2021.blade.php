...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <img src="{{ asset('imagenes/image21.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<main>
    <!-- Hero Section -->
    <section class="py-20 bg-gradient-to-r from-green-700 to-green-500 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Comprometidos con la reforma del Estado y la lucha contra la corrupción en el Perú.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">
                Trayectoria y evolución del Frente de la Esperanza 2021
            </p>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-600">
                        Fundado en 2020 por el excongresista y exministro Fernando Olivera, como sucesor del desaparecido Frente Esperanza.
                    </p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-600">
                        No logró completar su inscripción ante el JNE a tiempo, quedando fuera de las elecciones generales de 2021.
                    </p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-600">
                        En septiembre de 2021, logró su inscripción en el Registro de Organizaciones Políticas del JNE, permitiéndole participar en futuras elecciones.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Fernando Olivera</h3>
                    <p class="text-gray-600 mb-2 font-medium">Presidente del Partido</p>
                    <p class="text-gray-600">Excongresista y exministro, lidera el partido con una agenda centrada en la lucha contra la corrupción y la reforma del Estado.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Elizabeth León Chinchay</h3>
                    <p class="text-gray-600 mb-2 font-medium">Dirigente Nacional</p>
                    <p class="text-gray-600">Ingeniera y excandidata a la vicepresidencia, ha sido una figura clave en las campañas electorales del partido.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Comprometidos con erradicar la corrupción en todos los niveles del Estado.</p>
                </div>
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1">Reforma del Estado</h3>
                    <p class="text-gray-600 text-sm mb-4">Promovemos una reestructuración integral del Estado para hacerlo más eficiente y transparente.</p>
                </div>
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1">Justicia Social</h3>
                    <p class="text-gray-600 text-sm mb-4">Buscamos una sociedad más equitativa, con igualdad de oportunidades para todos.</p>
                </div>
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1">Descentralización</h3>
                    <p class="text-gray-600 text-sm mb-4">Impulsamos el fortalecimiento de las regiones y gobiernos locales para un desarrollo equilibrado.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Industrialización del Agro</h3>
                    <p class="text-gray-600">Propuesta para transformar el sector agrícola mediante la industrialización, mejorando la productividad y generando empleo.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-green-700 mb-4 text-4xl floating">
                    ...
                    <p class="text-gray-600">Impulsar cambios en el sistema judicial para garantizar una justicia más rápida, transparente y accesible para todos.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Cierre -->
    <section class="py-16 bg-gradient-to-r from-green-700 to-green-500 text-white text-center">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold mb-4 animate-on-scroll">¡Únete al Frente de la Esperanza 2021!</h2>
            <p class="text-xl max-w-2xl mx-auto mb-8 animate-on-scroll">
                Trabajamos por un Perú más justo, transparente y descentralizado. Sé parte del cambio.
            </p>
            <a href="https://www.partidofrentedelaesperanza2021.pe/" class="bg-white text-green-700 font-semibold px-6 py-3 rounded-full hover:bg-gray-200 transition">
                Conoce más
            </a>
        </div>
    </section>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image21.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

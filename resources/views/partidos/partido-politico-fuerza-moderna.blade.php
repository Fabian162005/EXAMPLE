...
<head>
    ...
    <title>partido politico fuerza moderna</title>
...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <img src="{{ asset('imagenes/image35.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<main>
    ...
    <section class="py-20 bg-blue-600 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Reconstruyendo la confianza en el Perú con sostenibilidad y modernización.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll text-green-600">Historia del Partido</h2>
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">
                Origen y evolución del Partido Fuerza Moderna
            </p>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-gray-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">
                        Fundado en mayo de 2023 por Fiorella Molinelli, exministra de Desarrollo e Inclusión Social y expresidenta de EsSalud.
                    </p>
                </div>
                ...
                <div class="bg-gray-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">
                        El 7 de agosto de 2024, el partido logró su inscripción en el Registro de Organizaciones Políticas del JNE.
                    </p>
                </div>
                ...
                <div class="bg-gray-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-700">
                        Incorporación de figuras destacadas como el expresidente Pedro Pablo Kuczynski y excongresistas del gobierno de PPK.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-green-50">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll text-green-600">Liderazgo Actual</h2>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Fiorella Molinelli</h3>
                    <p class="text-gray-700 mb-2 font-medium">Presidenta y Fundadora</p>
                    <p class="text-gray-700">Exministra de Desarrollo e Inclusión Social y expresidenta de EsSalud, lidera el partido con visión de modernización y sostenibilidad.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Pedro Pablo Kuczynski</h3>
                    <p class="text-gray-700 mb-2 font-medium">Miembro Destacado</p>
                    <p class="text-gray-700">Expresidente de la República, se unió al partido en 2024 para aportar su experiencia en políticas de crecimiento económico.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll text-green-600">Nuestros Principios</h2>
            <p class="text-xl text-gray-700 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Valores fundamentales</p>

            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-green-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-black">Participación Ciudadana</h3>
                    <p class="text-gray-700 text-sm">Fomentar la participación activa y consciente de la ciudadanía en la vida política.</p>
                </div>
                <div class="bg-green-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-black">Justicia Social</h3>
                    <p class="text-gray-700 text-sm">Promover la equidad y el acceso igualitario a oportunidades para todos los peruanos.</p>
                </div>
                <div class="bg-green-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-black">Transparencia</h3>
                    <p class="text-gray-700 text-sm">Impulsar políticas públicas transparentes y rendición de cuentas en todos los niveles del gobierno.</p>
                </div>
                <div class="bg-green-100 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1 text-black">Sostenibilidad Ambiental</h3>
                    <p class="text-gray-700 text-sm">Desarrollar políticas que aseguren el uso responsable de los recursos naturales y la protección del medio ambiente.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-100">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll text-green-600">Propuestas Clave</h2>
    ...
    <section class="py-16 bg-blue-600 text-white text-center">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold mb-4 animate-on-scroll">¡Únete a Fuerza Moderna!</h2>
            <p class="text-xl max-w-2xl mx-auto mb-8 animate-on-scroll">
                Trabajamos por un Perú más justo, inclusivo y sostenible. Sé parte del cambio.
            </p>
            <a href="https://www.fuerzamoderna.org.pe/" class="bg-white text-blue-600 font-semibold px-6 py-3 rounded-full hover:bg-gray-200 transition">
                Conoce más
            </a>
        </div>
    </section>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image35.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

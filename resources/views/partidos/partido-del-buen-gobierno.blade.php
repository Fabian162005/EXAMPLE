...
<head>
    ...
    <title>Partido del buen gobierno</title>
...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <img src="{{ asset('imagenes/image6.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<main>
    <!-- Hero Section -->
    <section class="py-20 bg-gradient-to-r from-red-900 to-red-700 text-white">
        <div class="container mx-auto px-4 text-center">
            <h1 class="text-4xl md:text-6xl font-bold mb-6 animate__animated animate__fadeInDown">Partido del Buen Gobierno</h1>
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Una visión ética, eficiente y sostenible del Estado peruano al servicio de la ciudadanía.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Orígenes y fundación</p>
            
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    <div class="text-red-700 mb-4 text-4xl floating">
                        <i class="fas fa-scale-balanced"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Fundación Ética</h3>
                    <p class="text-gray-600">Surgido en 2025 como respuesta a la crisis de confianza en las instituciones, desde la academia y sociedad civil.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Inspiración Republicana</h3>
                    <p class="text-gray-600">Promueve los valores democráticos, la división de poderes y la gestión pública profesionalizada.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale" style="animation-delay: 0.4s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Transparencia Radical</h3>
                    <p class="text-gray-600">Impulsa un sistema de gobierno abierto, con datos públicos accesibles y control ciudadano constante.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Referentes éticos y técnicos</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Dra. Isabel Alvarado</h3>
                    <p class="text-gray-600 mb-2 font-medium">Presidenta del partido</p>
                    <p class="text-gray-600">Jurista reconocida y exmagistrada constitucional. Lidera con firmeza ética y visión institucional.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Héctor Salvatierra</h3>
                    <p class="text-gray-600 mb-2 font-medium">Secretario Político</p>
                    <p class="text-gray-600">Economista con experiencia en planificación estatal. Coordina propuestas legislativas y alianzas institucionales.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Valores que nos rigen</p>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1">Transparencia Pública</h3>
                    <p class="text-gray-600 text-sm mb-4">Acceso a la información como derecho fundamental de la ciudadanía.</p>
                </div>
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1">Planificación de Estado</h3>
                    <p class="text-gray-600 text-sm mb-4">Proyectos con metas de largo plazo y estabilidad intergubernamental.</p>
                </div>
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1">Meritocracia</h3>
                    <p class="text-gray-600 text-sm mb-4">Acceso a la función pública por competencia, no por favoritismo político.</p>
                </div>
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1">Justicia Social</h3>
                    <p class="text-gray-600 text-sm mb-4">Reducción de desigualdades a través de políticas públicas sostenibles.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Nuestro compromiso con el futuro</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Reforma del Servicio Civil</h3>
                    <p class="text-gray-600">Concurso público obligatorio, evaluación de desempeño y promoción por méritos.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-red-700 mb-4 text-4xl floating">
                    ...
                    <p class="text-gray-600">Trámites 100% digitales y sistemas interoperables en todas las entidades del Estado.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-red-700 mb-4 text-4xl floating">
                        <i class="fas fa-hand-holding-usd"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Presupuesto Participativo</h3>
                    <p class="text-gray-600">Ciudadanía decide parte del presupuesto municipal en audiencias públicas obligatorias.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <div class="text-red-700 mb-4 text-4xl floating">
                        <i class="fas fa-users-cog"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Estado Coordinado</h3>
                    <p class="text-gray-600">Eliminación de duplicidades entre ministerios y gobiernos regionales con mapas de competencias.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Cierre -->
    <section class="py-16 bg-gradient-to-r from-red-900 to-red-700 text-white text-center">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold mb-4 animate-on-scroll">Recuperemos la confianza en el Estado</h2>
            <p class="text-xl max-w-2xl mx-auto mb-8 animate-on-scroll">
                Partido del Buen Gobierno: porque un Perú justo, eficiente y con futuro empieza con instituciones íntegras.
            </p>
        </div>
    </section>
</main>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image6.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

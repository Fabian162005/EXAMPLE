...
<head>
    ...
    <title>Nuevo Perú por el buen vivir</title>
...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div class="logo-container animate__animated animate__fadeIn">
            <img src="{{ asset('imagenes/image11.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<main>
    <!-- Hero Section -->
    <section class="py-20 bg-gradient-to-r from-red-400 to-red-600 text-black">
        <div class="container mx-auto px-4 text-center">
            <h1 class="text-4xl md:text-6xl font-bold mb-6 animate__animated animate__fadeInDown">Nuevo Perú por el Buen Vivir</h1>
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Partido político peruano de izquierda que promueve la justicia social, la diversidad cultural y la sostenibilidad de la vida.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll">Historia de Nuevo Perú</h2>
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Un movimiento por el Buen Vivir</p>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-600">Establecido el 9 y 10 de diciembre de 2017 en Lima, como sucesor del Movimiento Sembrar.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Ideología Progresista</h3>
                    <p class="text-gray-600">Inspirado en el socialismo democrático, el ecologismo, el feminismo y las luchas indígenas por la diversidad cultural y el Buen Vivir.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale" style="animation-delay: 0.4s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Inscripción en 2024</h3>
                    <p class="text-gray-600">Logró su inscripción oficial como partido político ante el JNE el 5 de julio de 2024, con presencia en 22 regiones y más de 29,000 afiliados.</p> 
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-600">Excongresista y excandidata presidencial, lidera el movimiento con una visión de transformación social y justicia para todos los peruanos.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Énver León</h3>
                    <p class="text-gray-600 mb-2 font-medium">Secretario General</p>
                    <p class="text-gray-600">Sindicalista comprometido con la organización popular y la construcción de un frente amplio democrático.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Compromiso con la justicia y la diversidad</p>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Promueve la equidad y la inclusión, luchando contra las desigualdades estructurales en la sociedad peruana.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.1s;">
                    <h3 class="text-xl font-semibold mb-1">Diversidad Cultural</h3>
                    <p class="text-gray-600 text-sm mb-4">Reconoce y valora la pluralidad de culturas, lenguas y tradiciones presentes en el Perú.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Aboga por un desarrollo que respete el medio ambiente y garantice el bienestar de las futuras generaciones.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.3s;">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Defiende los derechos de las mujeres y personas LGTBIQ+, promoviendo una sociedad libre de discriminación.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Agenda para un Perú justo y sostenible</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Proceso Constituyente</h3>
                    <p class="text-gray-600">Impulsa una nueva Constitución que refleje las aspiraciones del pueblo y garantice derechos fundamentales.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <p class="text-gray-600">Promueve políticas económicas y sociales que respeten el medio ambiente y fomenten la equidad.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image11.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

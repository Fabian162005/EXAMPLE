...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div class="logo-container animate__animated animate__fadeIn">
            <img src="{{ asset('imagenes/image8.png') }}" alt="Logo Acción Popular" class="logo-img">
        </div>
...
<main>
    <!-- Hero Section -->
    <section class="py-20 bg-gradient-to-r from-yellow-400 to-yellow-600 text-black">
        <div class="container mx-auto px-4 text-center">
            <h1 class="text-4xl md:text-6xl font-bold mb-6 animate__animated animate__fadeInDown">Libertad Popular</h1>
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate__animated animate__fadeIn animate__delay-1s">
                Partido liberal peruano que promueve la libertad individual, la economía social de mercado y un Estado eficiente al servicio de los ciudadanos.
            </p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-4 animate-on-scroll">Historia de Libertad Popular</h2>
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Un nuevo impulso liberal en el Perú</p>
            
            <div class="grid md:grid-cols-3 gap-8">
                <!-- Fundación -->
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale">
                    <div class="text-yellow-600 mb-4 text-4xl floating">
                        <i class="fas fa-flag"></i>
                    </div>
                    <h3 class="text-xl font-semibold mb-3">Fundación en 2022</h3>
                    <p class="text-gray-600">Establecido por Rafael Belaunde Llosa y Pedro Cateriano, obtuvo su inscripción oficial en junio de 2023.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Liberalismo Democrático</h3>
                    <p class="text-gray-600">Defiende la libertad individual, el respeto a la ley y una economía de mercado con justicia social.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow animate-on-scroll hover-scale" style="animation-delay: 0.4s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Rumbo al 2026</h3>
                    <p class="text-gray-600">Participará en las elecciones generales de 2026, proponiendo una alternativa liberal moderna y eficiente.</p> 
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Rafael Belaunde Llosa</h3>
                    <p class="text-gray-600 mb-2 font-medium">Presidente del partido</p>
                    <p class="text-gray-600">Exministro de Energía y Minas, lidera la propuesta liberal con énfasis en la eficiencia estatal y la inversión privada.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Pedro Cateriano</h3>
                    <p class="text-gray-600 mb-2 font-medium">Secretario de Política y Doctrina</p>
                    <p class="text-gray-600">Ex Presidente del Consejo de Ministros, aporta experiencia en gobernabilidad y defensa del orden democrático.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Compromiso con la libertad y el progreso</p>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    <h3 class="text-xl font-semibold mb-1">Libertad Individual</h3>
                    <p class="text-gray-600 text-sm mb-4">Defensa de los derechos fundamentales y las libertades civiles como pilares de la democracia.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.1s;">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Promoción de una economía social de mercado que fomente la inversión y el emprendimiento.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <p class="text-gray-600 text-sm mb-4">Impulso de un Estado moderno que garantice servicios públicos de calidad y respete la legalidad.</p>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.3s;">
                    <h3 class="text-xl font-semibold mb-1">Justicia y Transparencia</h3>
                    <p class="text-gray-600 text-sm mb-4">Compromiso con la lucha contra la corrupción y el fortalecimiento del sistema judicial independiente.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <p class="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto animate-on-scroll">Agenda para un Perú libre y próspero</p>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Fomento a la Inversión</h3>
                    <p class="text-gray-600">Creación de un entorno favorable para la inversión privada, generando empleo y desarrollo económico.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-transform animate-on-scroll hover-scale" style="animation-delay: 0.2s;">
                    ...
                    <h3 class="text-xl font-semibold mb-3">Servicios Públicos de Calidad</h3>
                    <p class="text-gray-600">Mejora de la educación y salud públicas, asegurando acceso equitativo y eficiente para todos los ciudadanos.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                <div class="flex justify-center md:justify-start mb-4">
                    <img src="{{ asset('imagenes/image8.png') }}" alt="Logo Grupo Paladines" class="h-20">
                </div>

  ...
  resultados.forEach(res => {
    ...
    resultadosContainer.appendChild(card);
        ...
        function abrirModal() {
            ...
            document.getElementById('modal-title').innerText = 'Subir Foto de Resultado';
        ...
        function editarFoto(id, archivo) {
            document.getElementById('foto_id').value = id;
            document.getElementById('modal-title').innerText = 'Editar Foto';
            document.getElementById('fotoModal').style.display = 'block';
        }

        function eliminarFoto(id) {
            if (confirm('¿Estás seguro de que deseas eliminar esta foto?')) {
                window.location.href = `/admin/resultados/eliminar/${id}`;
            }
        }
